...
const char* location="110101";
const char* key="d4055a0ac0848d29ab8bb6e4ad498d7a";
...
void loop() {
  ...
  String url = "https://restapi.amap.com/v3/weather/weatherInfo?&city=" + location + "&key=" + key + "&extensions=" + extensions;
