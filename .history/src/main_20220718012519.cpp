...
#include <TFT_eSPI.h>
#include <C:/Users/13248/OneDrive/文档/PlatformIO/Projects/gaodetianqiapi/.pio/libdeps/esp12e/TFT_eSPI/Tools/Create_Smooth_Font/Create_font/FontFiles/fontsimkai.h>
#define BLK 5
...
void setup() {
  ...
  tft.LOadF(fontsimkai);
  tft.drawString(city[0]+city[1]);
  tft.unlock();
}
void loop() {
  getapi();
