...
void putjson(const char* content){
  ...
  String city = forecasts_0_province + forecasts_0_city;
  ...
  city=String p(forecasts_0_city);
  tianqi=String s(forecasts_0_casts_0_dayweather);
  date=String q(forecasts_0_casts_0_date);
...
void xianshi(){
  for(int i=0;i>=80;i=i+30){
    tft.setCursor(20,i+20,3);
