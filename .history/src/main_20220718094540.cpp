...
void xianshi(const char* tianqiday[],const char* tianqinightp[],const char* date[]){
  ...
  tft.loadFont(fontsimakai_30);
  tft.drawCentreString(date[0],0,20,fontsimkai_30);
  tft.drawCentreString(tianqiday[0]+"转"+tianqinight[0],0,60,fontsimkai_30);
  tft.unloadFont();
}
//解析程序,预报未来3天的天气
...
void xianshi(tianqiday,tianqinight){
